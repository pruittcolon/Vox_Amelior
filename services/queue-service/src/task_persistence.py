...
class TaskPersistence:
    ...
    async def add_task(self, task_id: str, payload: dict[str, Any], max_retries: int = 3) -> bool:
        """
    ...
    async def mark_completed(self, task_id: str, result: dict[str, Any] | None = None) -> bool:
        """
    ...
    async def mark_failed(self, task_id: str, error: str, can_retry: bool = True) -> bool:
        """
        Mark task as failed
