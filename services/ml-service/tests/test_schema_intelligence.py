...
from core.schema_intelligence import (
    ColumnProfiler, SemanticType, BusinessEntity, summarize_profiles
)
from core.dataset_classifier import DatasetClassifier, BusinessDomain, MLTaskType
from core.applicability_scorer import ApplicabilityScorer, AnalyticsEngine
...
class TestDatasetClassifier(unittest.TestCase):
    ...
    def test_recommendations_generation(self):
        ...
        self.assertTrue(any('time-series' in rec.lower() or 'forecast' in rec.lower() 
