...
def mock_gpu_client():
    ...
    client = MagicMock()
    client.request_gpu = AsyncMock(return_value=MagicMock(acquired=True, task_id="ml-test-12345678", error=None))
...
def mock_gpu_client_unavailable():
    ...
    client = MagicMock()
    client.request_gpu = AsyncMock(return_value=MagicMock(acquired=False, task_id=None, error="GPU unavailable"))
    client.release_gpu = AsyncMock(return_value=True)
    return client
...
class TestMirrorEngineGPU:
    ...
    async def test_mirror_engine_gpu_acquisition(self, sample_dataframe, mock_gpu_client):
        ...
        from engines.mirror_engine import CUDA_AVAILABLE, MirrorEngine
...
class TestGalileoEngineGPU:
    ...
    async def test_galileo_engine_gpu_acquisition_updates_device(self, mock_gpu_client):
        ...
        import torch
        from engines.galileo_engine import CUDA_AVAILABLE, GalileoEngine
...
class TestTitanEngineGPU:
    ...
    def test_titan_model_configs_with_gpu(self):
        ...
        from engines.titan_engine import XGBOOST_AVAILABLE, _create_model_configs
    ...
    def test_titan_model_configs_without_gpu(self):
        ...
        from engines.titan_engine import _create_model_configs
