...
def test_statistical_engine():
    ...
    try:
        ...
        print(f"✅ Descriptive stats computed")
        ...
        # Test ANOVA
        result_anova = engine.analyze(df, {
            'analysis_types': ['anova'],
            'group_by': 'category'
        })
...
def test_anomaly_engine():
    ...
    try:
        ...
        if 10 in anomalies or 50 in anomalies:
            print(f"✅ Correctly detected injected anomalies")
...
def test_trend_engine():
    ...
    try:
        ...
        result = engine.analyze_trends(df, {
            'time_column': 'date',
