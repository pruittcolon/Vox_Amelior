...
class S3Loader:
    ...
    def __init__(
    ...
    ):  # endpoint_url for MinIO/LocalStack support
        """
        ...
        if aws_access_key_id and aws_secret_access_key:
            self.storage_options = {"key": aws_access_key_id, "secret": aws_secret_access_key, "client_kwargs": {}}
            if endpoint_url:
    ...
    def read_file(self, bucket: str, key: str, file_type: str | None = None, **kwargs) -> pd.DataFrame:
        """
