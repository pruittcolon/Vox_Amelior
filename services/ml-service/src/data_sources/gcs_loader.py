...
class GCSLoader:
    ...
    def __init__(
        self, project_id: str | None = None, credentials_path: str | None = None, endpoint_url: str | None = None
    ):  # endpoint_url for fake-gcs-server
        """
    ...
    def read_file(self, bucket_name: str, blob_name: str, file_type: str | None = None, **kwargs) -> pd.DataFrame:
        """
