...
class ExcelLoader:
    ...
    def load(self, file_path: str, sheet_name: Union[str, int, None, List[Union[str, int]]] = 0, **kwargs) -> Union[pd.DataFrame, Dict[str, pd.DataFrame]]:
        """
    ...
    def load_sample(self, file_path: str, sheet_name: Union[str, int] = 0, rows: int = 1000) -> pd.DataFrame:
