...
class ConfigParameter:
    ...
    default: Any
    range: list[Any] | None = None  # [min, max] for numbers, options for select
    description: str = ""
...
class TechnicalExplanation:
    ...
    methodology_url: str | None  # Link to documentation
...
class EngineAnalysisRequest:
    ...
    filename: str
    target_column: str | None = None  # Auto-detect if not provided
