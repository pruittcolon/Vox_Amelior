...
class AnalysisHistoryService:
    ...
    def saveSession(self, sessionId: str, filename: str, columns: list[str], rowCount: int | None = None) -> bool:
        """
    ...
    def getRun(self, sessionId: str, engineName: str, runIndex: int) -> dict[str, Any] | None:
        """
    ...
    def getSession(self, sessionId: str) -> dict[str, Any] | None:
