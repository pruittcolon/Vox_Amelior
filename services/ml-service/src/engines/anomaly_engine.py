...
class AnomalyEngine:
    ...
    def get_methodology_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "steps": [
                {"step_number": 1, "title": "Column Detection", "description": "Identify numeric columns via schema intelligence"},
                {"step_number": 2, "title": "Multi-Method Detection", "description": "Run Z-score, IQR, Isolation Forest, LOF, DBSCAN"},
                {"step_number": 3, "title": "Ensemble Voting", "description": "Aggregate results from multiple methods"},
