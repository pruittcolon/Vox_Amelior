...
class ProfitMarginEngine:
    ...
    def _generate_insights(self, results: Dict, rev_col: Optional[str] = None, profit_col: Optional[str] = None) -> List[str]:
